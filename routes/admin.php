...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::get('/get-restaurant-data', 'SystemController@restaurant_data_new')->name('get-restaurant-data');

        // Route::get('order-statistics', 'DashboardController@order_statistics')->name('order-statistics');
        Route::get('order-statistics', 'DashboardController@order_statistics_new')->name('order-statistics');
        
        Route::get('order-statistics2', 'DashboardController@order_statistics_new2')->name('order-statistics_2');
        ...
        Route::group(['prefix' => 'custom-role', 'as' => 'custom-role.', 'middleware' => ['module:user_management']], function () {
            ...
            Route::get('list', 'CustomRoleController@list')->name('list');
        ...
        Route::group(['prefix' => 'addon', 'as' => 'addon.', 'middleware' => ['module:product_management']], function () {
            ...
            Route::get('status/{id}', 'AddonController@status')->name('status');
        });

        Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.', 'middleware' => ['module:dispatch_management']], function () {
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.', 'middleware' => ['module:product_management']], function () {
            ...
            Route::get('category/{categoryId}', [ProductController::class, 'getProductsByCategory'])->name('getProductsByCategory');
            Route::post('update-position/{id}', 'ProductController@update_position')->name('update_position');
        });
        ...
        Route::group(['prefix' => 'gift-card', 'as' => 'gift_card.', 'middleware' => ['module:promotion_management']], function () {
            Route::get('/', [GiftCardController::class, 'show_dashboard'])->name('index');
            Route::post('/create', [GiftCardController::class, 'upload'])->name('upload');
            Route::post('update/{id}', [GiftCardController::class, 'update_status'])->name('updateStatus');
            Route::get('/orders', [GiftCardController::class, 'orders'])->name('orders');
        });
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:system_management']], function () {
            ...
            Route::group(['prefix' => 'ads-banner', 'as' => 'ads-banner.'], function () {
                Route::get('/', [BusinessSettingsController::class, 'ads_banner'])->name('index');
                Route::post('upload', [BusinessSettingsController::class, 'ads_banner_upload'])->name('upload');
                Route::post('delete/{id}', [BusinessSettingsController::class, 'ads_banner_delete'])->name('delete');
                Route::post('update/{id}', [BusinessSettingsController::class, 'ads_banner_update_status'])->name('updateStatus');
            });
        });
        ...
        Route::group(['prefix' => 'kitchen', 'as' => 'kitchen.', 'middleware' => ['module:chef_management', 'app_activate:' . APPS['kitchen_app']['software_id']]], function () {
