...
@section('content')
    <center><h3>Please do not refresh this page...</h3></center>
    ...
    <form method="POST" action="{!! route('paystack.payment',['token'=>$data->id]) !!}" accept-charset="UTF-8"
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <input type="hidden" name="email"  value="{{$payer->email!=null?$payer->email:'required@email.com'}}"> 
                ...
                <input type="hidden" name="metadata" value="{{ json_encode(['order_id' => $order_id, 'payment_id'=>$payment_id]) }}"> {{-- For other necessary things you want to add to your payload. it is optional though --}}
