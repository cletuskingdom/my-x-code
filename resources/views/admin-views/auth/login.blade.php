...
<head>
    ...
    <link rel="stylesheet" href="{{asset(env('APP_PUBLIC') . 'assets/admin')}}/css/style.css">
    ...
    <div class="auth-wrapper">
        <div class="auth-wrapper-left">
            <div class="auth-left-cont">
                ...
                <img width="310" src="{{asset('storage/app' . env('APP_PUBLIC') . 'restaurant/'. $restaurant_logo)}}"
                     onerror="this.src='{{asset(env('APP_PUBLIC') . 'assets/admin/img/logo.png')}}'">
                    ...
                    <form class="" id="form-id" action="{{route('admin.auth.login')}}" method="post">
                        ...
                        <div class="auth-header">
                            <div class="mb-5">
                                ...
                                <div class="text-capitalize">{{translate('welcome_back').' to Happy Belly Admin Panel'}}</div>
