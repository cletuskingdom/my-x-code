                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="category_id" id="category-id" class="form-control js-select2-custom"
                                                            ...
                                                            @foreach($categories as $category)
                                                                <option value="{{$category['id']}}" {{ $category->id == $product_category[0]->id ? 'selected' : '' }}>
                                                                    {{ $category['name'] }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <select name="category_ids" class="form-control">
                                                    @foreach ($categories_product as $posi_tion)
                                                        <option {{ (int)$count_++ == (int)$position ? 'selected' : '' }} value="{{ '[{' . '"id": "' . $product_category[0]->id . '", "position": "' . $count_2++ . '"}]' }}">
                                                            {{ $count_3++ }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-4">
                                                    <div class="">
                                                        <input required type="radio" name="grouping" value="{{$group->id}}" @if($group->id === $product->grouping_id) checked @endif> <label class="input-label">{{$group->name}}</label>
                                                    </div>
                                                </div>
                                                @endforeach
