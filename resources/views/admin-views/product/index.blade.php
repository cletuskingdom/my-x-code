                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="product_type" class="form-control js-select2-custom">
                                                            ...
                                                            <option value="non_veg" selected>{{translate('nonveg')}}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="discount_type" class="form-control js-select2-custom" id="discount_type">
                                                            ...
                                                            <option value="amount" selected>{{translate('amount')}}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="tax_type" class="form-control js-select2-custom" id="tax_type">
                                                            <option selected disabled>---{{translate('select')}}---</option>
                                                            <option value="percent" selected>{{translate('percentage')}}</option>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="tax_input" type="number" min="0" step="any" name="tax" class="form-control"
                                                               placeholder="{{translate('Ex : $100')}}" value="7.5" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-4">
                                                    <div class="">
                                                        ...
                                                        <input required type="radio" name="grouping" value="{{$group->id}}" @if($index === 0) checked @endif> <label class="input-label">{{$group->name}}</label>
                                                    </div>
                                                </div>
                                                @endforeach
