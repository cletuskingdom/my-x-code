                                ...
                                <div class="card-body">
                                    <div class="payment--gateway-img">
                                        <img style="height: 80px"
                                            src="{{asset('storage/app/' . env('APP_PUBLIC') .'payment_modules/gateway_image')}}/{{$additional_data != null ? $additional_data->gateway_image : ''}}"
                                            onerror="this.src='{{asset(env('APP_PUBLIC') . 'assets/admin/img/placeholder.png')}}'"
                                            alt="public"
                                        />
                                    </div>
