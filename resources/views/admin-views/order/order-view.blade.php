                    ...
                    <div class="px-card py-3">
                        <div class="row gy-2">
                            <div class="col-sm-6 d-flex flex-column justify-content-between">
                                ...
                                <h5>Rider {{translate('note')}} : {{$order['order_note']}}</h5>
                                <h5>Kitchen {{translate('note')}} : {{$order['kitchen_note']}}</h5>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="text-sm-right">
                                    ...
                                    <div class="d-flex gap-3 justify-content-sm-end mb-3 text-capitalize">
                                        ...
                                        <label class="badge-soft-info px-2 rounded">{{$order['add_cutlery'] == 0 ?'Yes':'No'}}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9 col-lg-8">
                                <dl class="row">
                                    ...
                                    <dd class="col-6 text-dark text-right">
                                        ...
                                        {{ \App\CentralLogics\Helpers::get_business_settings('service_fee')}}
                                    </dd>
                                    ...
                                    <dd class="col-6 border-top pt-2 fz-16 font-weight-bold text-dark text-right">{{ \App\CentralLogics\Helpers::set_symbol($sub_total - $order['coupon_discount_amount'] - $order['extra_discount'] + $del_c + 100) }}</dd>
                ...
                <div class="col-lg-4">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <p>
                                <span><b>Order Created:</b> </span>{{ $order->created_at ?? 'N/A' }}
                            </p>
                            <p>
                                <span><b>Order Confirmed:</b> </span>{{ $order->confirmed_at ?? 'N/A' }}
                            </p>
                            <p>
                                <span><b>Kitchen Starting:</b> </span>{{ $order->kitchen_start ?? 'N/A' }}
                            </p>

                            <p>
                                <span><b>Kitchen Finished:</b> </span>{{ $order->kitchen_end ?? 'N/A' }}
                            </p>
                            <p>
                                <span><b>Order Assigned:</b> </span>{{ $order->order_assigned ?? 'N/A' }}
                            </p>
                            <p>
                                <span><b>Order delivered:</b> </span>{{ $order->order_completed ?? 'N/A' }}
                            </p>
                        </div>
                    </div>
