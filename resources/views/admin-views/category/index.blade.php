                        ...
                        <div class="row">
                            @if ($data && array_key_exists('code', $data[0]))
                                <div class="col-md-6">
                                    @foreach ($data as $lang)
                                        ...
                                        <input type="checkbox" name="attach_menu" value="1" onchange="toogleMenuElements(event)"> <label for="">Attach Menu</label>
                                    @endforeach
                                </div>
                            @else
                                ...
                                <div class="from_part_2 mt-2">
                                    <div class="form-group">
                                        <div class="text-center">
                                            <img width="105" class="rounded-10 border" id="viewer" src="{{ asset('public/assets/admin/img/400x400/img2.jpg') }}" alt="image" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4 menu-element">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="menu_title" class="form-control" placeholder="e.g Genesis of rice" value="{{old('menu_title')}}">
                                </div>

                                <div class="form-group">
                                    <label for="">Menu Description</label>
                                    <textarea name="menu_description" rows="4" class="form-control" placeholder="Describe this menu">{{old('menu_description')}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4 menu-element">
                                ...
                                <div class="from_part_2 mt-4 px-4">
                                    <div class="form-group">
                                        <div class="text-center">
