                ...
                <div class="navbar-brand-wrapper justify-content-between">
                    ...
                    <a class="navbar-brand" href="{{route('admin.dashboard')}}" aria-label="Front">
                        <img class="navbar-brand-logo" style="object-fit: contain;"
                             onerror="this.src='{{asset(env('APP_PUBLIC') . 'public/assets/admin/img/160x160/img2.jpg')}}'"
                             src="{{asset('storage/app/' . env('APP_PUBLIC') . 'restaurant/'.$restaurant_logo)}}"
                             alt="Logo">
                        <img class="navbar-brand-logo-mini" style="object-fit: contain;"
                             onerror="this.src='{{asset(env('APP_PUBLIC') . 'public/assets/admin/img/160x160/img2.jpg')}}'"
                             src="{{asset('storage/app/' . env('APP_PUBLIC') . 'restaurant/'.$restaurant_logo)}}" alt="Logo">
                    </a>
                    <!-- End Logo -->
...
{{--                        @endif--}}
                        ...
                        @if(Helpers::module_permission_check(MANAGEMENT_SECTION['promotion_management']))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/gift-card')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.gift_card.index')}}">
                                    <i class="tio-gift nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('gift_card')}}</span>
                                </a>
                            </li>

                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/gift-card/orders*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.gift_card.orders')}}">
                                    <i class="tio-gift nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Gift Cards Orders</span>
                                </a>
                            </li>
...
{{--                        HELP & SUPPORT MANAGEMENT--}}
                        ...
                        @if(Helpers::module_permission_check(MANAGEMENT_SECTION['report_and_analytics_management']))
                            ...
                            @endif
                            @if(Helpers::module_permission_check(MANAGEMENT_SECTION['dispatch_management']))
                            ...
                            @endif
                            @if(Helpers::module_permission_check(MANAGEMENT_SECTION['sales_management']))
                    ...
                    {{--   REPORT & ANALYTICS MANAGEMENT END--}}
                                ...
                                <li class="navbar-vertical-aside-has-menu {{Request::is('admin/custom-role*') || Request::is('admin/employee*')?'active':''}}">
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub " style="display: {{Request::is('admin/custom-role*') || Request::is('admin/employee*')?'block':''}}">
                                        ...
                                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/custom-role*')?'active':''}}">
                                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="{{translate('Employee Role Setup')}}">
                                            ...
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{Request::is('admin/employee*')?'block':''}}">
                                                ...
                                                <li class="nav-item {{Request::is('admin/employee/list')?'active':''}}">
                                                    <a class="nav-link" href="{{route('admin.custom-role.list')}}" title="{{translate('Employee Role Setup')}}">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                            {{translate('List')}}</span>
                                                    </a>
                        ...
                        @if(Helpers::module_permission_check(MANAGEMENT_SECTION['chef_management']))
                    ...
                    <!-- Table Management End-->
                        ...
                        <!-- Ads Banner start -->
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/ads-banner*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.business-settings.ads-banner.index') }}">
                                <i class="tio-email nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
