...
class Order extends Model
{
    ...
    public function getScreenIdAttribute()
    {
        static $screenCounter = 0; // Static variable to track screen assignment

        $totalScreens = 2; // Modify this to fetch from DB in the future

        $screenCounter = ($screenCounter + 1) % $totalScreens;
