...
class CustomRoleController extends Controller
{
    ...
    {
        $roles = $this->admin_role->where('name', '<>', 'Master Admin')->paginate(10);
        return view('admin-views.custom-role.list', compact('roles'));
    }
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        return redirect(route('admin.custom-role.list'));
    }
