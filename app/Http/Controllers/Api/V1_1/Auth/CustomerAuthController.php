...
class CustomerAuthController extends Controller
{
    ...
    {
        // return response()->json(['APP_KEY' => env("APP_KEY")], 200);
        // return response()->json(['resp' => $request->all()], 200);
    ...
    // public function  as sendOTPSMS(Request $request)
    // {
    //     $validator = Validator::make($request->all(),[
    //         'email'     => 'sometimes|email|exists:users',
    //         'purpose'   => 'required|string',
    //         'phone'       => 'sometimes|min:11|max:11|exists:users',
    //     ]);
    ...
    //     return UserAuthService::sendOTP(
    //         Helpers::sanitize_input($request->email), 
    //         Helpers::sanitize_input($request->phone),
    //         Helpers::sanitize_input($request->purpose)
    //     );
    // }
    ...
    {
        $validator = Validator::make($request->all(), [
            // phone validation: prevent 0 to be the first digit and also ensure it is exactly 10 digits
    ...
    //     return UserAuthservice::check_email($);
    // }
