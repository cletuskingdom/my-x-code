...
class PaymentController extends Controller
{
    ...
    public function payment(Request $request)
    {
        if (!session()->has('payment_method')) {
            ...
            session()->put('payment_method', 'monnify');
        }
        ...
        $redirect_link = Payment::generate_link($payer, $payment_info, $receiver_info, $request->remove_cutlery ? $request->remove_cutlery : false);
